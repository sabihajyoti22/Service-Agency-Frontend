<template>
  <div class="fixed w-full bg-navy/30 backdrop-blur-[5px] py-3 z-50">
    <div class="default-layout">
      ...
      <div
        class="w-full h-screen md:h-fit text-white md:flex md:justify-between fixed md:static transition md:translate-x-0 duration-300 top-14 bg-navy/30 backdrop-blur-[5px] md:bg-white/0 md:backdrop-blur-none z-50 md:z-0"
        :class="toogle ? 'translate-x-0' : 'translate-x-full'"
      >
        <div class="flex flex-col md:flex-row gap-5 md:gap-2 md:grow">
          <a
            href="/"
